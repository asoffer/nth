#ifndef NTH_DEBUG_TRACE_INTERNAL_MATCHER_FORMATTER_H
#define NTH_DEBUG_TRACE_INTERNAL_MATCHER_FORMATTER_H
...
template <typename F>
struct MatcherFormatter {
  explicit constexpr MatcherFormatter(F& f) : formatter_(f) {}

  template <CompileTimeString Name, typename Fn, typename... Ts>
  void operator()(auto& printer,
                  BoundExpectationMatcher<Name, Fn, Ts...> const& m) {
    DrawPrefix(printer);
...
#endif  // NTH_DEBUG_TRACE_INTERNAL_MATCHER_FORMATTER_H
