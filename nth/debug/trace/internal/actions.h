...
#define NTH_TRACE_INTERNAL_DEFINE_BINARY_OPERATOR_ACTION(Op, op)               \
  struct Op {                                                                  \
...
NTH_TRACE_INTERNAL_DEFINE_BINARY_OPERATOR_ACTION(Le, <=)
NTH_TRACE_INTERNAL_DEFINE_BINARY_OPERATOR_ACTION(Lt, <)
NTH_TRACE_INTERNAL_DEFINE_BINARY_OPERATOR_ACTION(Eq, ==)
NTH_TRACE_INTERNAL_DEFINE_BINARY_OPERATOR_ACTION(Ne, !=)
NTH_TRACE_INTERNAL_DEFINE_BINARY_OPERATOR_ACTION(Ge, >=)
NTH_TRACE_INTERNAL_DEFINE_BINARY_OPERATOR_ACTION(Gt, >)
NTH_TRACE_INTERNAL_DEFINE_BINARY_OPERATOR_ACTION(Cmp, <=>)

NTH_TRACE_INTERNAL_DEFINE_BINARY_OPERATOR_ACTION(And, &)
NTH_TRACE_INTERNAL_DEFINE_BINARY_OPERATOR_ACTION(Or, |)
NTH_TRACE_INTERNAL_DEFINE_BINARY_OPERATOR_ACTION(Xor, ^)

NTH_TRACE_INTERNAL_DEFINE_BINARY_OPERATOR_ACTION(Add, +)
NTH_TRACE_INTERNAL_DEFINE_BINARY_OPERATOR_ACTION(Sub, -)
NTH_TRACE_INTERNAL_DEFINE_BINARY_OPERATOR_ACTION(Mul, *)
NTH_TRACE_INTERNAL_DEFINE_BINARY_OPERATOR_ACTION(Div, /)
NTH_TRACE_INTERNAL_DEFINE_BINARY_OPERATOR_ACTION(Mod, %)

NTH_TRACE_INTERNAL_DEFINE_BINARY_OPERATOR_ACTION(LSh, <<)
NTH_TRACE_INTERNAL_DEFINE_BINARY_OPERATOR_ACTION(RSh, >>)
NTH_TRACE_INTERNAL_DEFINE_BINARY_OPERATOR_ACTION(ArrowPtr, ->*)

#undef NTH_TRACE_INTERNAL_DEFINE_BINARY_OPERATOR_ACTION
