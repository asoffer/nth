...
#define NTH_DEBUG_INTERNAL_TRACE_EXPECT(...)                                   \
  NTH_DEBUG_INTERNAL_TRACE_EXPECT_WITH_VERBOSITY((::nth::v.always), __VA_ARGS__)
#define NTH_DEBUG_INTERNAL_TRACE_EXPECT_WITH_VERBOSITY(verbosity, ...)         \
  if (::nth::internal_trace::Responder<nth::internal_trace::Explain, [] {}>    \
          responder;                                                           \
      (std::is_constant_evaluated() or                                         \
       (verbosity).predicate_(::nth::source_location::current())) and          \
      responder.set(                                                           \
          (#__VA_ARGS__),                                                      \
...
#define NTH_DEBUG_INTERNAL_TRACE_ASSERT(...)                                   \
  NTH_DEBUG_INTERNAL_TRACE_ASSERT_WITH_VERBOSITY((::nth::v.always), __VA_ARGS__)
